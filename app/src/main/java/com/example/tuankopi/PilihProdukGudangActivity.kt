    ...
    private fun muatKatalogProductAktif() {
        mFirestore.collection("products")
            ...
            .addOnFailureListener { e ->
                Toast.makeText(this, "Gagal memuat katalog: ${e.localizedMessage}", Toast.LENGTH_SHORT).show()
            }
    }

    private fun eksekusiSimpanKolektifGudang() {
        if (keranjangJumlahLokal.isEmpty()) {
            Toast.makeText(this, "Mohon isi jumlah jatah produksi minimal pada satu produk!", Toast.LENGTH_SHORT).show()
            return
        }
        ...
        mFirestore.runTransaction { transaction ->
            ...
            Toast.makeText(this, "Batch logistik harian berhasil disinkronkan!", Toast.LENGTH_SHORT).show()
            finish()
        }.addOnFailureListener { e ->
            Toast.makeText(this, "Gagal mengalkulasi transaksi: ${e.localizedMessage}", Toast.LENGTH_SHORT).show()
        }
    }
